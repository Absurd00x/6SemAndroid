package ru.mirea.petrov.networkstate;
...
public class NetworkLiveData extends LiveData<String> {
    ...
    // Отслеживание изменения состояния сети осществляется через BroadcastReceiver.
    // При изменении состояния генерируется сообщение для всех слушателей в системе.
