package ru.mirea.petrov.camera;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Выполняется проверка на наличие разрешений на использование камерыи запись в память
    ...
    /**
     *  Производится генерирование имени файла на основе текущего
     *  времени и создание файла в директории Pictures на ExternelStorage.class
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        // производится проверка полученного результата от пользователя на
